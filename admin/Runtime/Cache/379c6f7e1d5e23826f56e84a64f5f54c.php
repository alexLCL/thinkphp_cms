...
<form enctype="multipart/form-data" action="__URL__/addClassAction" method="post" id="u">

    <table id="customers" align="center">
        <tr>
            <th width="30%" style="text-align:right">主分类型名称</th>
            <th style="text-align:left"><input type="text" name="addcName"> </th>
        </tr>
