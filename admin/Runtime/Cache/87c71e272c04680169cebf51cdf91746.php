...
<form enctype="multipart/form-data" action="__URL__/updAction/cId/<?php echo ($cId); ?>" method="post" id="rs">

    <table id="customers" align="center">

        <tr>
            <th width="30%" style="text-align:right">类型名称:</th>
            <th style="text-align:left"><input type="text" name="cName" value="<?php echo ($cName); ?>"></th>
        </tr>
        <tr>
            <th>
            </th>
