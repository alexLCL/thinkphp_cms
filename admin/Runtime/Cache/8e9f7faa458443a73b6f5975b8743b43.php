...
<form action="" method="get">
    ...
    <table id="customers" align="center">
        ...
        <?php if(is_array($rs)): $i = 0; $__LIST__ = $rs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="alt">
                ...
                <td><img src="__ROOT__/<?php echo ($vo["bLogo"]); ?>" width="80" height="60"></td>
                <td>
                    <a href="__URL__/upBrand/id/<?php echo ($vo["bId"]); ?>">修改</a>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="__URL__/delBrand/id/<?php echo ($vo["bId"]); ?>">删除</a>
                </td>
