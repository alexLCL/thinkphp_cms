...
<form enctype="multipart/form-data" action="__URL__/add" method="post" id="u">
    ...
    <table id="customers" align="center">
        ...
        <tr>
            ...
            <th style="text-align:left"><input type="password" name="addpass"></th>
        </tr>
        <tr>
            <th width="30%" style="text-align:right">头像</th>
