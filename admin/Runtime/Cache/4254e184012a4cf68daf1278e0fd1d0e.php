...
<form enctype="multipart/form-data" action="__URL__/addSonAction/cId/<?php echo ($cId); ?>" method="post" id="u">

    <table id="customers" align="center">
        <tr>
            <th width="30%" style="text-align:right">添加到类型</th>
            <th style="text-align:left"><font color="black"> <?php echo ($cName); ?></font></th>
        </tr>
        <tr>
            <th width="30%" style="text-align:right">子类型名称</th>
            <th style="text-align:left"><input type="text" name="addSname"> </th>
        </tr>
        <tr>
            <th>
