			...
			if(updir && updir!='about:blank'){
				...
				this.createDialog( {
					...
					ok   : function() {
						...
						_src = _APP+_src;
						var _insertHTML = '<images src="'+(_src||'http://www.baidu.com/images/baidu_sylogo1.gif')+'" ';
		...
		if(updir && updir!='about:blank'){
			...
			this.createDialog( {
				...
				ok   : function() {
					...
					var _insertHTML = '<images src="'+$.TE.basePath()+'skins/'+_self.editor.opt.skins+'/images/spacer.gif" class="_flash_position" style="';
